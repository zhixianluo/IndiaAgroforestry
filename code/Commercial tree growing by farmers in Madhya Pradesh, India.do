...
* 5 Data for Supplementary Figure 3, Planting dates for commercial tree species planted by farmers
...
* 7.1 Covariates & obs used to run COVSEL for Treatment 1
...
* 7.2 Covariates & obs used to run COVSEL for Treatment 2
use TemporaryDataset.dta 
